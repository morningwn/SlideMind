...
const desktopApi: Readonly<DesktopApi> = Object.freeze({
  ...
  exportDiagnosticBundle: () =>
    ipcRenderer.invoke('logging:export-diagnostics'),
  openCrashReportDirectory: () =>
    ipcRenderer.invoke('logging:open-crash-directory'),
...
const agentApi: Readonly<AgentApi> = Object.freeze({
  ...
  saveConfig: (input: SaveAgentConfigInput) =>
    ipcRenderer.invoke('agent:save-config', input),
  listSkills: (projectHandle: string) =>
    ipcRenderer.invoke('agent:list-skills', projectHandle),
  getTodos: (input: AgentConversationInput) =>
    ipcRenderer.invoke('agent:get-todos', input),
  getUsage: (input: AgentConversationInput) =>
    ipcRenderer.invoke('agent:get-usage', input),
...
const projectApi: Readonly<ProjectApi> = Object.freeze({
  ...
  listFiles: (projectHandle: string) =>
    ipcRenderer.invoke('project:list-files', projectHandle),
