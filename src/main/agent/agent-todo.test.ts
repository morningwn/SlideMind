...
const tasks = [
  ...
  { id: 2, subject: '建立叙事', activeForm: '正在建立叙事', status: 'in_progress' },
  { id: 3, subject: '制作页面', status: 'pending', blockedBy: [2] },
